  ...
  <aside class="cart">
    ...
    <div class="cart__body">
      <div class="cart-list-header">
        <span class="cart-list-header__count">{{ products.length }} {{ normalize }}</span>
        <button class="cart-list-header__reset" @click="deleteAllCart">очистить список</button>
      </div>
      <div class="cart-list">
        <div class="cart-item" v-for="product in products" :key="product.id">
          ...
          <div class="cart-item__control">
            <button class="cart-item__control-button" @click="decreaseCount(product.id)">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
            ...
            <button class="cart-item__control-button" @click="addToCart(product.id)">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
          ...
          <button class="cart-item__delete" @click="deleteOneProduct(product.id)">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
