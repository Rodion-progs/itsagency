...
export default new Vuex.Store({
    ...
    products: [
      {
        ...
        tags: ["Новинки", "Есть в наличии", "Эксклюзивные", "Контрактный"],
      },
      {
        id: 2,
        title: "Краска Wallquest, Brownsone MS90102",
        ...
        tags: ["Новинки", "Есть в наличии", "Контрактный"],
      },
      {
        id: 3,
        title: "Краска Wallquest, Brownsone MS90102",
        ...
        tags: ["Новинки", "Есть в наличии", "Эксклюзивные"],
      },
      {
        id: 4,
        title: "Краска Wallquest, Brownsone MS90102",
      ...
      },
      {
        ...
        tags: ["Есть в наличии", "Контрактный"],
      },
      {
        id: 7,
        title: "Краска Wallquest, Brownsone MS90102",
        ...
        tags: ["Новинки", "Эксклюзивные", "Контрактный"],
      },
      {
        id: 8,
        title: "Краска Wallquest, Brownsone MS90102",
        price: 5290,
        img: require("../assets/img/products/product_7.jpg"),
        tags: ["Есть в наличии", "Контрактный", "Распродажа"],
      },
      {
        id: 9,
        title: "Краска Wallquest, Brownsone MS90102",
      ...
      },
      {
        ...
        price: 6000,
        img: require("../assets/img/products/product_6.jpg"),
        tags: ["Есть в наличии", "Эксклюзивные", "Контрактный"],
      },
      {
        id: 12,
        title: "Краска Wallquest, Brownsone MS90102",
      ...
      },
      {
        ...
        price: 3400,
        img: require("../assets/img/products/product_9.jpg"),
        tags: ["Новинки", "Есть в наличии", "Контрактный", "Распродажа"],
      },
    ],
    cartProducts: [],
    filteredProduct: [],
  ...
  mutations: {
    ...
    changeFilter(state, payload) {
      ...
      ).selected = !state.filters.find((item) => item.title === payload)
        .selected;
    },
  ...
  actions: {
    setCartProduct({ getters, commit }, id) {
      const alreadyInCart = getters.getProductsInCart.some(
        (item) => item.id === id
      );
      if (alreadyInCart) {
  ...
  getters: {
    ...
    getFilteredProducts: (state, getters) => {
      ...
      const activeFilter = getters.getActiveFilters.map((item) => item.title);
    ...
    sortingProducts: (state, getters) => {
      ...
      if (state.sorting.sortBy === "price") {
        ...
        return products.sort(
          (a, b) => a.tags.includes("Новинки") - b.tags.includes("Новинки")
        );
      }
    },
